...
print("Lane rate FPGA",sys.fpga.config["vco_select"].value[0] / sys.fpga.config["d_select"].value[0])
print("Lane rate Converter",sys.converter.bit_clock / sys.fpga.config["rate_divisor_select"].value[0])
